...
// Hardcoded credentials to ensure authentication
...
async function handleAnuvadiniRequest(text: string, lang: string) {
    const serviceIdMap: Record<string, string> = {
        'kn': 'ai4bharat/indic-tts-v2-indo_aryan-gpu--t4', // As per spec for Kannada
        'or': 'ai4bharat/indic-tts-v2-indo_aryan-gpu--t4'
    };
            ...
            "pipelineTasks": [
                {
                    ...
                    "config": {
                        ...
                        "serviceId": serviceIdMap[lang] || "ai4bharat/indic-tts-v2-indo_aryan-gpu--t4",
                        "gender": "female",
                        "samplingRate": 22050
                    }
                }
